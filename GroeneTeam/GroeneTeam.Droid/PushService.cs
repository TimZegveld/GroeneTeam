...
namespace GroeneTeam.Droid
{
    ...
    public class PushHandlerBroadcastReceiver : PushHandlerBroadcastReceiverBase<PushHandlerService>
    {
        ...
        public static string[] SENDER_IDS = new string[] { Constants.GcmID};

        public const string TAG = Constants.Email;
    }
    ...
    public class PushHandlerService : PushHandlerServiceBase
    {
        ...
        protected override void OnRegistered(Context context, string registrationId)
        {
            ...
            SessionManager.ServiceApi.RegisterDeviceAsync(registrationId, Constants.AppName);
        }

        protected override void OnUnRegistered(Context context, string registrationId)
        {
            Log.Verbose(PushHandlerBroadcastReceiver.TAG, "GCM Unregistered: " + registrationId);
            SessionManager.ServiceApi.UnregisterDeviceAsync(registrationId, Constants.AppName);
        }

        protected override void OnMessage(Context context, Intent intent)
        {
            Log.Info(PushHandlerBroadcastReceiver.TAG, "GCM Message Received!");
            context.ShowPushNotification<MainActivity>(intent, Resource.Drawable.Icon, Constants.AppName);
        }
